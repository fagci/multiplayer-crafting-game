...
conzole = (function ($parent, undefined) {
    ...
    function wrapConsole() {
        ...
        console.log     = function () {
            if (console.formerLog) {
                console.formerLog.apply(this, arguments);
            }
            conzole.log.apply(this, arguments);
        }
        console.debug   = function () {
            if (console.formerDebug) {
                console.formerDebug.apply(this, arguments);
            }
            conzole.debug.apply(this, arguments);
        }
        console.info    = function () {
            if (console.formerInfo) {
                console.formerInfo.apply(this, arguments);
            }
            conzole.info.apply(this, arguments);
        }
        console.warn    = function () {
            if (console.formerWarn) {
                console.formerWarn.apply(this, arguments);
            }
            conzole.warn.apply(this, arguments);
        }
        console.error   = function () {
            if (console.formerError) {
                console.formerError.apply(this, arguments);
            }
            conzole.error.apply(this, arguments);
        }
        console.time    = function (arg) {
            if (console.formerTime) {
                console.formerTime(arg);
            }
            conzole.time(arg);
        }
        console.timeEnd = function (arg) {
            if (console.formerTimeEnd) {
                console.formerTimeEnd(arg);
            }
            conzole.timeEnd(arg);
        }
    }
    ...
    function onHandleMove(e) {
        setWidth(getWindowSize().width - Math.max(e.pageX, 0));
    }
